...
### 5. **Интерфейс для сотрудников аэропорта**
- **Атрибуты**:
  - Входные данные багажа
  - Визуализация схемы укладки
- **Операции**:
  - Ввод данных о багаже
  - Отображение оптимальной схемы укладки.
- **Связи**:
  - Приём управляющих команд от сотрудников.
  - Получает данные от алгоритма укладки.
  - Передаёт данные сотрудникам для реализации укладки.

### 6. **Сотрудник аэропорта**
- **Атрибуты**:
  - Должность
  - Уровень доступа к интерфейсу
- **Операции**:
  - Замер веса и размеров багажа.
  - Ввод данных в интерфейс.
  - Получение и реализация схемы укладки.
- **Связи**:
  - Взаимодействует с интерфейсом для ввода данных и получения инструкций.
  - Передаёт данные о багаже в систему.
...
#### 5. **Грузовой оператор (для логистических компаний)**
- **Функции**:
  - Ввод данных о грузах (вес, размеры, хрупкость).
  - Получение и реализация схемы укладки грузов.
- **Ограничения**:
  - Доступ только к функциям, связанным с грузами.
  - Не может изменять настройки системы или алгоритмы.
- **Назначение роли**:
  - Роль назначается администратором логистической компании.
